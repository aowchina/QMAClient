...
/**
 * Created by zhangjiachang on 15/9/28.
 */
public class PullScrollView extends ScrollView {
    ...
    // 刷新、加载更多 接口
    private OnRefreshListener		onRefrehListener;
...
//	}
    ...
    public void setOnRefreshListener(OnRefreshListener onRefrehListener) {
        this.onRefrehListener = onRefrehListener;
    }
