 ...
 */
public class ReproveMeAdapter extends BaseAdapter {
    private Context context;
    private List<GroupArticle> list;
    private LayoutInflater inflater;

    public ReproveMeAdapter(Context context, List<GroupArticle> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView = inflater.inflate(R.layout.item_reprove_me,null);
...
//        viewHolder.tvReplyText.setText(groupArticle.getText());
        viewHolder.tvMyText.setText(Html.fromHtml("<font color='#fa4288'>"+"我的帖子: "+"</font>"+groupArticle.getText2()));
