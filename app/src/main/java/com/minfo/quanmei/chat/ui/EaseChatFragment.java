package com.minfo.quanmei.chat.ui;
...
import com.minfo.quanmei.chat.controller.EaseUI;
import com.minfo.quanmei.chat.domain.EaseAtMessageHelper;
import com.minfo.quanmei.chat.domain.EaseEmojicon;
import com.minfo.quanmei.chat.domain.EaseUser;
import com.minfo.quanmei.chat.utils.EaseCommonUtils;
import com.minfo.quanmei.chat.utils.EaseUserUtils;
import com.minfo.quanmei.chat.widget.EaseAlertDialog;
import com.minfo.quanmei.chat.widget.EaseAlertDialog.*;
import com.minfo.quanmei.chat.widget.EaseChatExtendMenu;
import com.minfo.quanmei.chat.widget.EaseChatInputMenu;
import com.minfo.quanmei.chat.widget.EaseChatInputMenu.*;
import com.minfo.quanmei.chat.widget.EaseChatMessageList;
import com.minfo.quanmei.chat.widget.EaseVoiceRecorderView;
import com.minfo.quanmei.chat.widget.EaseVoiceRecorderView.*;
import com.minfo.quanmei.chat.widget.chatrow.EaseCustomChatRowProvider;
...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    private void sendAtMessage(String content) {
        ...
        if (EMClient.getInstance().getCurrentUser().equals(group.getOwner()) && EaseAtMessageHelper.get().containsAtAll(content)) {
            message.setAttribute(Constant.MESSAGE_ATTR_AT_MSG, Constant.MESSAGE_ATTR_VALUE_AT_MSG_ALL);
        } else {
            message.setAttribute(Constant.MESSAGE_ATTR_AT_MSG,
    ...
    protected void forwardMessage(String forward_msg_id) {
        ...
        switch (type) {
            case TXT:
                if (forward_msg.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
                    sendBigExpressionMessage(((EMTextMessageBody) forward_msg.getBody()).getMessage(),
                            forward_msg.getStringAttribute(Constant.MESSAGE_ATTR_EXPRESSION_ID, null));
                } else {
